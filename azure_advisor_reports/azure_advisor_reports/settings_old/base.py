...
MIDDLEWARE = [
    'django.middleware.gzip.GZipMiddleware',  # Response compression - must be first
...
# Compress responses to reduce bandwidth by up to 70%
GZIP_COMPRESSION_LEVEL = 6  # Balance between compression and CPU usage (1-9)
...
# Query Optimization
# Use select_related and prefetch_related in querysets to reduce N+1 queries

# Cache Configuration for Performance
# Redis caching is already configured above with 5-minute default timeout
# Custom cache timeouts defined in apps/reports/cache.py:
